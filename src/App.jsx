  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <main className="flex-1 min-w-0 overflow-auto flex flex-col pt-14 md:pt-0">
        ...
        <footer className="px-3 md:px-6 py-3 text-xs text-gray-400 border-t border-gray-200 flex items-center justify-between">
          <span>&copy; {new Date().getFullYear()} <a href="https://designpixels.nl" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-600 transition-colors">Design Pixels</a></span>
          <button onClick={() => setCurrentPage('changelog')} className="text-gray-400 hover:text-blue-600 transition-colors">v{currentVersion}</button>
        </footer>
      </main>
    </div>
  );
